...
<h2 class="form-signin-heading"><?php echo isset($_GET['id']) ? 'Update user' : 'Create user' ?></h2>
...
<?php $this->widget(
    ...
    array('buttonType' => 'submit', 'type' => 'primary', 'label' => isset($_GET['id']) ? 'Update user' : 'Create user')
); ?>
<?php $this->endWidget(); ?>